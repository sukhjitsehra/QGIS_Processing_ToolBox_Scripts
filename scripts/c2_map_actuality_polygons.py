...
polygon_symbolizer = mapnik.PolygonSymbolizer()	#green
polygon_symbolizer2 = mapnik.PolygonSymbolizer()	# yellow
polygon_symbolizer3 = mapnik.PolygonSymbolizer()	# orange
polygon_symbolizer4 = mapnik.PolygonSymbolizer()	# red

polygon_symbolizer.fill= mapnik.Color('green')
polygon_symbolizer2.fill= mapnik.Color('yellow')
polygon_symbolizer3.fill= mapnik.Color('orange')
polygon_symbolizer4.fill= mapnik.Color('red')
