...
save_dir="/media/office/New Volume/Research/Sukhjit/ExperimentalDataThesis/OSMData/NetworkAnalysis/OSM_NOV_2015/DistrictwiseNetworkAnalysisGraphml/eccentricity"
...
for fname in iglob(walk_dir + '**/*.graphml'):
    ...
    print 'graph and strong graph success'
